...
tree_files = [file for file in all_files if file.endswith('_final_sbs_support_pandit_v2.raxml.support')]
results = []
...
df_res.to_csv(os.path.join(os.pardir, "data/sbs_simulation_pandit_v2.csv"))
