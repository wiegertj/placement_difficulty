...
for folder_name in folder_names:
    ...
    print(abs_path)
    tree_ebg_path = abs_path + f"/{dataset}.phy_bs_over_70_support_prediction.newick"
    tree_lower5_path = abs_path + f"/{dataset}.phy_uncertainty_bs_over_70_support_prediction.newick"
...
df_res.to_csv(os.path.join(os.pardir, "data/ebg_simulation_70_unc.csv"))
