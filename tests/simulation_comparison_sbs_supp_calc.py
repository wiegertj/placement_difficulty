...
folder_path = '/hits/fast/cme/wiegerjs/placement_difficulty/data/processed/raxml_sbs_simulations'
import ete3
...
for folder_name in tree_files:
    ...
    dataset = folder_name.replace(".phy.raxml.bootstraps", "")
    ...
    prefix = dataset + "_final_sbs_support_"
