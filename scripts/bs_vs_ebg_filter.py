...
msa_df = pd.read_csv("/hits/fast/cme/wiegerjs/placement_difficulty/data/processed/features/msa_features.csv")
msa_df["msa_name"] = msa_df["dataset"]
df_final = df_final.merge(msa_df, on=["msa_name"], how="inner")
...
df_final = df_final.groupby('msa_name').sample(1)
...
df = df_final[["ratio", "effect", "uncertainty", "max_support", "sequence_length", "difficulty", "min_1", "max_1","mean_1", "std_1", "skew_1", "kurt_1",
               ...
               "avg_gaps_msa","cv_gaps_msa","kur_gaps_msa","sk_gaps_msa","avg_entropy_msa","std_entropy_msa","max_entropy_msa","sk_entropy_msa","kur_entropy_msa","num_seq","seq_length","g_fraction_msa","c_fraction_msa","a_fraction_msa","t_fraction_msa","rest_fraction_msa","aa_stat_min","aa_stat_max","aa_stat_std","aa_stat_mean","approxEntropy_ape_msa","cumSum_p_msa","cumSum_abs_max_msa","cumSum_mode_msa","spec_p_msa","spec_n1_msa","spec_d_msa","matrix_p_msa","complex_p_msa","complex_xObs_msa","randex_0_msa","randex_1_msa","randex_2_msa","randex_3_msa","randex_4_msa","randex_5_msa","randex_6_msa","randex_7_msa","run_pi_msa","run_vObs_msa","run_one_p_msa","run_one_x0bs_msa","run_one_mean_msa","run_one_std_msa","run_one_min_msa","run_one_max_msa","site_taxa_ratio_msa","percentage_invariant_sites_msa"]]
