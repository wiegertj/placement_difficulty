...
for file in filenames:
    ...
    support_path_no_boot = os.path.join(grandir, "scripts/") + file.replace(".newick", "") + "_parsimony_20000.raxml.support"
    support_path_boot = os.path.join(grandir, "scripts/") + file.replace(".newick", "") + "_parsimony_supp_499.raxml.support"
    ...
    output_prefix_no_boot = file.split(".")[0] + "_parsimony_20000"  # Using the filename as the prefix
    output_prefix_boot = file.split(".")[0] + "_parsimony_499"  # Using the filename as the prefix
