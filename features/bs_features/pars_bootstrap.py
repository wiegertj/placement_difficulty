...
df_res = pd.DataFrame(results, columns=["dataset", "branchId", "parsimony_boot_support",
                                        "min_pars_bootsupp_child", "max_pars_bootsupp_child",
                                        "mean_pars_bootsupp_child", "std_pars_bootsupp_child", "skw_pars_bootsupp_child",
                                        "min_pars_bootsupp_child_w", "max_pars_bootsupp_child_w",
                                        "mean_pars_bootsupp_child_w", "std_pars_bootsupp_child_w", "skw_pars_bootsupp_child_w",
                                        "min_pars_bootsupp_parents", "max_pars_bootsupp_parents",
                                        "mean_pars_bootsupp_parents", "std_pars_bootsupp_parents", "skw_pars_bootsupp_parents",
                                        "min_pars_bootsupp_parents_w",
                                        "max_pars_bootsupp_parents_w",
                                        "mean_pars_bootsupp_parents_w", "std_pars_bootsupp_parents_w",
                                        "skw_pars_supp_parents_w",
                                        "min_pars_bootsupp_tree", "max_pars_bootsupp_tree", "std_pars_bootsupp_tree",
                                        "skw_pars_bootsupp_tree",
                                        "mean_pars_bootsupp_tree"

                                        ])
df_res.to_csv(os.path.join(grandir, "data/processed/features/bs_features/parsimony_boot.csv"))
