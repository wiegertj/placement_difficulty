...
def compute_rf_distance_statistics(support_file_path, reference_tree_path):
    ...
    with open(support_file_path, "r") as support_file:
        for line in support_file:
            ...
            rf_distance = reference_tree.robinson_foulds(bootstrap_tree)[0]
...
for file in filenames:
    counter +=1
    print(counter)
    bootstrap_file = pd.read_csv(os.path.join(os.pardir, "data/data/raw/reference_tree/") + file + ".raxml.support")
