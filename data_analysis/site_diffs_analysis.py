...
for msa_file in msa_files:
    ...
    for id in col_id:
        ...
        data = {
            ...
            "count_a": count_a_list[id],
            "count_t": count_t_list[id],
            "count_c": count_c_list[id],
            "count_g": count_g_list[id],
            "avg_count_a": np.mean(count_a_list),
            "avg_count_t": np.mean(count_t_list),
            "avg_count_c": np.mean(count_c_list),
            "avg_count_g": np.mean(count_g_list),
